  ...
  return (
    <main>
      <div className="container">
        {/* <div className={Classes.breadcrumb}>1뎁스 2텝스 3뎁스</div> */}
          ...
          <div className={Classes.article}>
            ...
            <div className={Classes.articleBody}>
              <p>
                ...
                무엇을 보내는 든 칼이다. 붙잡아 설산에서 인생의 이것은 그들의 수
                피다. 같이, 인생에 만천하의 맺어, 열락의 아니다. 실현에 눈이
                이상이 피다. 무엇이 원질이 힘차게 예가 것이다. 봄날의 미묘한
                간에 위하여, 이상은 뼈 쓸쓸하랴? 만천하의 사라지지 그들은 우는
                얼마나 부패뿐이다.
              </p>
              <h5>글의 큰 섹션입니다</h5>
              <h6>글의 작은 섹션입니다</h6>
              <p>
                ...
                그림자는 얼마나 내려온 무엇을 예수는 공자는 목숨이 운다. 든
                부패를 투명하되 우리의 같으며, 봄바람을 영원히 것이다. 같은
                이상은 인류의 인생에 기쁘며, 앞이 같지 피가 것이다. 얼음이
                청춘을 사라지지 더운지라 그러므로 천지는 천고에 우리는 인간이
                쓸쓸하랴? 끓는 보배를 얼음과 크고 때문이다. 작고 온갖 굳세게
                별과 그림자는 있으랴? 하는 풍부하게 우리 봄바람을 원대하고, 간에
                하였으며, 부패뿐이다. 청춘의 청춘의 원질이 청춘에서만 위하여,
                위하여 것이다.
              </p>
              <h6>글의 작은 섹션입니다</h6>
              <p>
                ...
                뿐이다. 더운지라 이상은 우리 황금시대의 끓는다. 날카로우나
                가슴에 실현에 철환하였는가? 풀밭에 위하여 온갖 내려온 있는 있다.
              ...
              <p>
                ...
                천자만홍이 말이다. 타오르고 피어나는 장식하는 이것이야말로
                동산에는 청춘이 착목한는 아니한 뿐이다. 석가는 뼈 피는 보라.
                유소년에게서 꽃 동력은 황금시대의 것이다. 찬미를 그들의 인생을
                사막이다. 고동을 인간의 위하여, 이상의 미묘한 미인을 생생하며,
                일월과 운다.
              </p>
            </div>
          </div>
